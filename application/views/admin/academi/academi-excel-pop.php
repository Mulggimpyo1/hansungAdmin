      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="academiExcelForm" enctype="multipart/form-data" action="/admin/home/academiExcelProc" method="POST">
...
{
  location.href="/assets/admin_resources/academy_add_excel.xlsx";
}

function uploadExcel(){
  $('#academiExcelForm').submit();
}
</script>
