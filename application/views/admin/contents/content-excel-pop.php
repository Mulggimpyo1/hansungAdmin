      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="contentExcelForm" enctype="multipart/form-data" action="/admin/home/contentExcelProc" method="POST">
...
{
  location.href="/assets/admin_resources/audio_booklist_sample_new.xlsx";
}

function uploadExcel(){
  $('#contentExcelForm').submit();
}
</script>
