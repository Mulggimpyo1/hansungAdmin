            ...
            <form role="form" id="boardWriteForm" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="edu_title" id="edu_title" placeholder="제목을 작성해주세요" value="">
                </div>
                <div class="form-group">
                  <label style="margin-left:5px; margin-top:5px;">
                    <input type="radio" name="edu_display_yn" value="Y" checked/> 노출
                  </label>
                  <label style="margin-left:5px; margin-top:5px;">
                    <input type="radio" name="edu_display_yn" value="N"/> 비노출
                  </label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="edu_contents" id="ir1" style="display:none;"></textarea>
...
<script>
  ...
  function writeProc(){
    ...
    $.ajax({
      type: "POST",
      url : "/admin/contentAdm/eduWriteProc",
      data: formData,
      dataType:"json",
      processData: false,
      contentType: false,
