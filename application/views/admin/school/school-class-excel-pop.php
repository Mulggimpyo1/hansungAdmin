      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="schoolExcelForm" enctype="multipart/form-data" action="/admin/schoolAdm/schoolClassExcelProc" method="POST">
...
{
  location.href="/assets/admin_resources/school_class_add_excel.xlsx";
}

function uploadExcel(){
  $('#schoolExcelForm').submit();
}
</script>
