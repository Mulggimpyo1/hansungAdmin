      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="schoolExcelForm" enctype="multipart/form-data" action="/admin/schoolAdm/schoolExcelProc" method="POST">
...
{
  location.href="/assets/admin_resources/school_add_excel.xlsx";
}
