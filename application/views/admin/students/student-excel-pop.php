      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="studentExcelForm" enctype="multipart/form-data" action="/admin/home/studentExcelProc" method="POST">
...
{
  location.href="/assets/admin_resources/student_add_excel_new.xlsx";
}
