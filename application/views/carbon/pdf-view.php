...
<script src="/assets/pdfjs/build/pdf.js"></script>
  ...
  <script src="/assets/pdfjs/web/viewer.js?<?php echo date("YmdHis") ?>"></script>

  </head>

  <body tabindex="1" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <button id="secondaryCloseFile" class="secondaryToolbarButton visibleLargeView" title="Close File" tabindex="51" data-l10n-id="close_file" onclick="self.close();">
              <span data-l10n-id="colse_file_label">닫기</span>
            </button>
