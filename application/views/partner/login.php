...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">파트너 로그인</p>

      <form id="login_form">
        <div class="input-group mb-3">
          <input type="hidden" id="csrf" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>"/>
          <input id="partner_id" name="partner_id" type="text" class="form-control" placeholder="Id">
        ...
        <div class="input-group mb-3">
          <input name="partner_password" id="partner_password" type="password" class="form-control" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
...
<script>
  ...
  $('#partner_password').keypress(function(e){
    if(e.keyCode == 13 ){
      login_proc();
    }
  });
