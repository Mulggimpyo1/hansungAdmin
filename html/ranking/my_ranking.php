		...
		<div class="ranking_wrap">
			<div class="ranking_top">
				...
				<div class="ranking_search">
					...
					<div class="sub_tab">
						<ul>
							<li><a href="#" class="on">개인 랭킹</a></li>
							<li><a href="#">학급 랭킹</a></li>
							<li><a href="#">학교 랭킹</a></li>
						</ul>
					</div>
					<div class="only_check">
						<span class="uicheckbox_wrap uicheckbox_size12">
							<input type="checkbox" id="only-my" class="uicheckbox_check">
					...
					<div class="list_ranking">
						<ul>
							<li>
								...
								<span class="user">홍길동<span class="school">(학교-학년-반)</span></span>
							...
							<li class="my_rank">
								<span class="rank_num">500</span>
								<span class="user">홍길동<span class="school">(학교-학년-반)</span><span class="rate">상위15%</span></span>
								<span class="co2">4000kg</span>
							</li>
						</ul>
					</div>
